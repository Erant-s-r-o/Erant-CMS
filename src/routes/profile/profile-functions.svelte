<script lang="ts">
	...
	import ProfileUpdate from './account/settings/Profile-Update.svelte'
	import Setting from './account/settings/Setting.svelte'
	import Cookies from './account/settings/Cookies.svelte'
	import InterestsUpdate from './account/settings/Interests-Update.svelte'
